...
/******/ 	__webpack_require__.p = "/Users/carlos/Projects/json-api/example";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsonApiReducer = __webpack_require__(1127);
	
	var _jsonApiReducer2 = _interopRequireDefault(_jsonApiReducer);
	
	var createStoreWithMiddleware = (0, _redux.applyMiddleware)(_reduxThunk2['default'])(_redux.createStore);
	var store = createStoreWithMiddleware((0, _redux.combineReducers)({
	  apiStore: _jsonApiReducer2['default']
	}));
	...
	function getAttribute(obj, attributeName, defaultValue) {
	  return (obj || _immutable2['default'].fromJS({})).getIn(['attributes', attributeName], defaultValue);
	}
	...
	var App = _reactAddons2['default'].createClass({
	  ...
	  loadFavoriteMovies: function loadFavoriteMovies(e) {
	    e.preventDefault();
	    this.props.loadFavoriteMovies();
	  },
	
	  render: function render() {
	    var store = this.props.applicationState;
	
	    var currentUserId = store.getIn(['session', 'current-session', 'attributes', 'userId']);
	    var currentUserEmail = store.getIn(['user', currentUserId, 'attributes', 'email']);
	    var movieComponents = store.get('movie', _immutable2['default'].Map()).reduce(function (movieComponents, value, id) {
	      var _this = this;
	
	      var fav = function fav(e) {
	        e.preventDefault();
	        _this.props.favoriteMovie(id);
	      };
	      movieComponents.push(_reactAddons2['default'].createElement(
	        'li',
	        { key: id },
	        value.getIn(['attributes', 'title'])
	      ));
	      return movieComponents;
	    }, []);
	
	    var isLoadingPage = store.getIn(['user', currentUserId, 'relationships', 'favorite-movies', 'isLoadingPage']);
	    var nextPageHref = store.getIn(['user', currentUserId, 'relationships', 'favorite-movies', 'nextPageHref']);
	    var loadMoreLink = 'Nothing to load';
	    if (isLoadingPage) {
	      loadMoreLink = 'loading...';
	    } else if (nextPageHref) {
	      loadMoreLink = _reactAddons2['default'].createElement(
	        'a',
	        { href: '#', onClick: this.loadFavoriteMovies },
	        'Load favorites'
	      );
	    }
	    ...
	    return _reactAddons2['default'].createElement(
	      ...
	      _reactAddons2['default'].createElement(
	        'pre',
	        { style: { float: 'left' } },
	        JSON.stringify(store.toJS(), null, ' ')
	      )
	    );
	  }
	});
	
	var SmartApp = (0, _reactRedux.connect)(function (state) {
	...
	window.onload = function () {
	  _reactAddons2['default'].render(_reactAddons2['default'].createElement(
	    ...
	    { store: store },
	    function () {
	      return _reactAddons2['default'].createElement(SmartApp, null);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsBindActionCreators = __webpack_require__(182);
	...
	var _utilsCompose = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsMapValues = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.loadFavoriteMovies = loadFavoriteMovies;
	exports.login = login;
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }
	
	var _axios = __webpack_require__(1114);
	
	var _axios2 = _interopRequireDefault(_axios);
	
	function loadRelationship(dispatch, href, type, id, name) {
	  var relationship = { type: type, id: id, name: name };
	  dispatch({
	    type: 'RELATIONSHIP_LOAD_START',
	    relationship: relationship
	  });
	
	  _axios2['default'].get('http://patient-tree-3875.getsandbox.com' + href).then(function (response) {
	...
	function loadFavoriteMovies() {
	  return function (dispatch, getState) {
	    var state = getState();
	    var userId = state.apiStore.getIn(['session', 'current-session', 'attributes', 'userId']);
	    var href = state.apiStore.getIn(['user', userId, 'relationships', 'favorite-movies', 'nextPageHref']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaults = __webpack_require__(1116);
	var utils = __webpack_require__(1117);
	var dispatchRequest = __webpack_require__(1118);
	var InterceptorManager = __webpack_require__(1125);
	...
	axios.spread = __webpack_require__(1126);
	  ...
	  return new Promise(function (resolve, reject) {
	    try {
	      ...
	      if ((typeof XMLHttpRequest !== 'undefined') || (typeof ActiveXObject !== 'undefined')) {
	        __webpack_require__(1119)(resolve, reject, config);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaults = __webpack_require__(1116);
	var utils = __webpack_require__(1117);
	var buildUrl = __webpack_require__(1120);
	var parseHeaders = __webpack_require__(1121);
	var transformData = __webpack_require__(1122);
	...
	module.exports = function xhrAdapter(resolve, reject, config) {
	  ...
	  if (utils.isStandardBrowserEnv()) {
	    var cookies = __webpack_require__(1123);
	    var urlIsSameOrigin = __webpack_require__(1124);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loadData(state, object) {
	  ...
	  state = state.setIn([type, id, 'id'], id).setIn([type, id, 'type'], type).mergeDeepIn([type, id, 'attributes'], object.attributes);
	...
	function loadHasMany(state, type, id, relationshipName, action) {
	  var relationshipList = state.getIn([type, id, 'relationships', relationshipName, 'data'], _immutable2['default'].List());
	  return getData(action.data).reduce(loadData, state).mergeIn([type, id, 'relationships', relationshipName], {
	    nextPageHref: action.links.next,
	    size: action.meta.size,
	    data: relationshipList.concat(action.data.map(function (_ref) {
	      var id = _ref.id;
	      var type = _ref.type;
